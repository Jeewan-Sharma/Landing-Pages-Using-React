...
const Recipes = () => {
  return (
    <div className="lg:px-8 py-7 background bg-right flex flex-wrap gap-8 lg:gap-0">
      <div className="w-full lg:w-4">
        <div className="m-2 h-full bg-white border-round border-bottom	p-5 border-custom-primary-color">
          <img
          ...
          <p className="mt-4 text-lg">
            Lorem ipsum dolor sit amet, consectetur elitelit adipiscing elit.
            Sed nec aliquet turp. Integer luctus magna mi, vel tempus felis
            tempor ornare.
          </p>
        </div>
      </div>
